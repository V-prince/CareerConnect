...
const JobDetailPopup = ({ job, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm p-3 md:p-6 overflow-y-auto">
      <div className="min-h-full flex items-center justify-center">
        <div className="w-full max-w-6xl bg-gray-100 rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-white border-b border-zinc-200">
            <div className="px-5 md:px-8 py-5">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-zinc-900">
                        {job.title}
                      </h2>
                ...
                <button
                  onClick={onClose}
                  className="w-10 h-10 rounded-lg bg-zinc-100 hover:bg-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-800 transition shrink-0"
                >
                  <FaTimes />
                </button>
              </div>
            ...
            <div className="grid lg:grid-cols-3 gap-5">
              ...
              <div className="space-y-5">
                <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-5">
                  <h3 className="font-bold text-zinc-800 mb-5">
                    About Company
                  </h3>
          ...
          <div className="bg-white border-t border-zinc-200 px-5 md:px-7 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
