...
export const DeleteAccountPopup = ({ isOpenDeletePopup, SetisOpenDeletePopup }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl p-6 w-[90%] max-w-md">
        ...
        <p className="text-sm text-zinc-500 mt-2">
          Are you sure you want to delete account? This action is irreversible and will permanently remove all your data from our system. Please proceed with caution.
        </p>

        <div className="flex justify-end gap-3 mt-6">
          <button onClick={() => SetisOpenDeletePopup(false)}
